...
\noindent
Con el objetivo de calcular el orden de convergencia de dichos métodos haremos 10 iteraciones de ellos por cada uno de los siguientes valores de h = { 0.5; 0.2; 0.1; 0.05; 0.02} para así obtener el orden entre cada uno de los tamaños de pasos usando la siguiente fórmula:
...
\begin{tabular}{|>{\centering\arraybackslash}p{1.7cm}|c|c|c|c|}
\hline
\textbf{Método} & \textbf{0.5→0.2} & \textbf{0.2→0.1} & \textbf{0.1→0.05} & \textbf{0.05→0.02} \\
\hline
Euler & 1.0595 & 1.0249 & 1.0122 & 1.0055 \\
\hline
Euler Mejorado & 2.1025 & 2.0429 & 2.0218 & 2.0099 \\
\hline
Runge-Kutta 4 & 4.1104 & 4.0470 & 4.0241 & 4.0109 \\
\hline
\end{tabular}
\end{table}

El promedio de los órdenes de convergencia de los métodos numéricos es de: 1.0209 para el Método de Euler, 2.0363 para el Método de Euler Mejorado y 4.0394 para el Método de Runge-Kutta 4.
